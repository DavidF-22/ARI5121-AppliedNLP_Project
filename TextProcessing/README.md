...
After installing the dependencies in the virtual environment, open the notebook in a code IDE or Jupyter Notebook environment and selecting the `Run All` option to execute all cells sequentially.
